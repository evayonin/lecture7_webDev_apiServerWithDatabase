...
public class GeneralController {//קונטרולר->מחלקה שמאזינה לבקשות
    ...
    public BasicResponse getAllUsers () {
        return new AllUsersResponse(
                true,
                null,
                dbUtils.getAllUsers()); // העדכון ההכי אחרון מההרצאה - אחרי יצירת הדאטה בייס והמחלקה שמטפלת בשאילתות ושומרת את רשומות היוזרים בטבלת יוזרים - יציג את הרשימות בטבלה בתור רשימה
    }
